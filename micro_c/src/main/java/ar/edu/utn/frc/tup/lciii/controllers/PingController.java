...
public class PingController {
    ...
    public String rps(@PathVariable String eleccionJugador) {
        counter++;
        if (playerWins > 5 && counter < 30) {
            System.out.println("Call N° " + counter + " - Micro C fuera de servicio");
            throw new RuntimeException("Micro C ya no quiere jugar, vuelva mas tarde!");
        }
        System.out.println("Call N° " + counter + " - jugando con Micro C");
    ...
    public String jugarPiedraPapelTijeras(String eleccionJugador) {
        ...
        if (eleccionJugador.equals(eleccionComputadora)) {
            ...
            return "Jugaste al rps con Micro C y empataron";
            ...
            playerWins++;
            return "Jugaste al rps con Micro C y ganaste";
        } else {
            System.out.println("¡Computadora gana!");
            pcWins++;
            return "Jugaste al rps con Micro C y perdiste";
